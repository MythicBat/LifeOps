...
from .tools.life_objects import (
...
class LifeOpsService:
    def __init__(self):
        ...
        self.observer = LifeOpsObserver(
            self.model
        )

        self.planner = LifeOpsPlanner(
            self.model
        )
    ...
    def process_document(
        ...
        if (
            ...
            is_subscription = any(
                vendor in vendor_lower
                for vendor
                in known_subscriptions
            )
